...
○   ○   ○`}</pre>
        ...
        <p className="receipt-note">
          ...
          Nacion. En ese supuesto, {appName} podra disponer del equipo en concepto de compensacion por
          los servicios prestados y los gastos de guarda. {appName} no se responsabiliza por la perdida
